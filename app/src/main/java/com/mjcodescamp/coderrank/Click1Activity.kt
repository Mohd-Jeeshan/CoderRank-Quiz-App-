    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioG1.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            ...
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB1.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB2.isChecked || radioB3.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG3.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB9.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB7.isChecked || radioB8.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG9.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            ...
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                ...
                if ((radioB25.isChecked || radioB26.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG10.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB29.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB28.isChecked || radioB30.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG13.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB37.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB38.isChecked || radioB39.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
