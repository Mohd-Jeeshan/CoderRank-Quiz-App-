...
class Click3Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        radioG2.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB4.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB5.isChecked || radioB6.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG3.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB7.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB8.isChecked || radioB9.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG4.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB11.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB10.isChecked || radioB12.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG8.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB23.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB22.isChecked || radioB24.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG12.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB36.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB34.isChecked || radioB35.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG14.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB41.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB40.isChecked || radioB42.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
        ...
        radioG17.setOnCheckedChangeListener(object : RadioGroup.OnCheckedChangeListener {
            var x = 0
            override fun onCheckedChanged(group: RadioGroup?, checkedId: Int) {
                if (radioB50.isChecked && x==0){
                    x = checkedId
                    right++
                }
                if ((radioB49.isChecked || radioB51.isChecked) && x==0){
                    wrong++
                    x = checkedId
                }
            }
